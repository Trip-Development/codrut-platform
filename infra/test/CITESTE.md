...
2. **Nume unice de servicii:**  
   Serviciile se numesc `testbackend`, `testfrontend`, `testworker`, `testdb`, `testredis`. Chiar și în cazul unei erori de rețea, nu există niciun nume comun care să se poată ciocni cu producția.
