...
PROMOTIONAL_SHELL_CLOSE = (
    ...
    '<p style="margin:0 0 8px;">Ai primit acest email deoarece ești abonat la '
    "actualizările noastre sau ești un client.</p>"
    '<p style="margin:0 0 8px;"><a href="${unsubscribe_url}" '
    'style="color:#6d5f5b;text-decoration:underline;">Dezabonare</a></p>'
    '<p style="margin:0;">${legal_address}</p></div></div>'
)
...
# Official campaign templates are imported from protected content packages.
...
TRANSACTIONAL_TEMPLATES: dict[TransactionalTemplateKey, TransactionalTemplate] = {
    TransactionalTemplateKey.account_setup: TransactionalTemplate(
        ...
        html_body=(
            ...
            + "pentru ${company_name}. Pentru rolul tău, primul pas este activarea "
        ...
        text_body=(
            ...
            "${trainer_name} te-a invitat în Cody pentru ${company_name}.\n"
            "Activează contul: ${action_url}\n\n"
    ...
    TransactionalTemplateKey.assignment_bundle: TransactionalTemplate(
        ...
        html_body=(
            ...
            + "chestionare de completat într-un link securizat. Nu ai nevoie de cont. "
        ...
        text_body=(
            "Bună, ${participant_name}.\n\n"
            "Ai ${task_count} chestionare Cody pentru ${company_name}.\n"
    ...
    TransactionalTemplateKey.assignment_reminder: TransactionalTemplate(
        ...
        text_body=(
            "Bună, ${participant_name}.\n\n"
            "Mai ai chestionare de completat pentru ${company_name}.\n"
            "Continuă aici: ${action_url}\n\n"
            "Linkul este personal și nu trebuie redirecționat."
        ),
        required_context=frozenset(
            {"participant_name", "company_name", "action_url"}
        ),
    ),
}
