    ...
    results: [
      ...
      },
      {
        ...
        scores: {
          ...
          icare_02_conduce_prin_puterea_exemplului: { score: 3.8 },
          icare_03_creeaza_un_mediu_care_stimuleaza_implicarea: { score: 3.6 },
          icare_06_aduce_claritate: { score: 3.1 },
          icare_12_agilitate_antreprenoriala: { score: 4.0 },
        },
      },
    ],
    cards: [
