  ...
  return (
    <main className="app-min-height flex items-center justify-center bg-background px-4 py-10">
      <section className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-surface p-6 shadow-sm">
        ...
        <h1 className="text-center text-2xl font-bold text-foreground">Seteaza parola noua</h1>
        <p className="mt-2 text-center text-sm leading-6 text-foreground/60">Ecran recuperat pentru callback-ul de recovery sau setup initial.</p>
        ...
        <button className="tap-soft mt-4 w-full rounded-xl bg-burgundy px-4 py-3 font-semibold text-white">Salveaza parola</button>
        <p className="mt-5 text-center text-sm">
          <Link href="/participant" className="font-semibold text-burgundy">Continua la workspace</Link>
        </p>
      </section>
    </main>
  );
