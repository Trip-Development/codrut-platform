...
export function ProjectSettingsForm({ project }: { project: CompanyProject }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl border border-[var(--border)] bg-surface p-5 shadow-sm">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <Field label="Nume proiect" value={name} onChange={setName} required />
