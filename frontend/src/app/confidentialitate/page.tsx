    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          content: <><p>Datele sunt păstrate cât timp sunt necesare proiectului, obligațiilor contractuale și securității. Furnizorii tehnici primesc doar accesul necesar operării serviciului și sunt supuși obligațiilor de confidențialitate.</p><p>Când un contact de campanie este arhivat, acesta nu mai apare în listele sau campaniile active și nu mai poate fi folosit pentru trimiteri. Dacă nu este șters definitiv mai devreme, contactul poate fi restaurat din Arhivă timp de 30 de zile. După acest termen, datele directe de contact și legăturile cu campaniile sunt șterse automat, iar istoricul de trimitere este păstrat numai fără identificatorii direcți necesari contactării.</p><p>După ștergerea datelor directe pot rămâne numai marcaje codificate, create cu o cheie secretă, pornind de la adresa de email, linkul de dezabonare sau confirmările furnizorului de email. Ele ne ajută să respectăm dezabonarea, să nu retrimitem către o adresă respinsă și să procesăm confirmări întârziate fără a readuce datele șterse. Aceste marcaje rămân date pseudonimizate protejate, nu date anonime.</p><p>Fiecare marcaj păstrat are o dată de revizuire în cel mult 12 luni. Marcajele folosite doar pentru confirmări întârziate sunt șterse la această revizuire. Cele necesare pentru o respingere permanentă sau o dezabonare sunt revizuite cel puțin anual și păstrate numai cât timp sunt necesare pentru a împiedica o nouă trimitere nedorită.</p></>,
        },
        {
